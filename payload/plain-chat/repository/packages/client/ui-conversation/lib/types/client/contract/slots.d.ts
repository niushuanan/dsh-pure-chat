...
import type { ComposerKeyboard, DraftAttachmentId, EditSelection, InputActions, InputNotice, InputState, PersistedInputDraft } from '../input/contract.ts';
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
    interface SlotMap {
        ...
        'conversation.hero.actions': {
            kind: 'list';
            scope: 'session';
            owner: HeroSessionActionOwnerProps;
        };
        /**
...
export type ComposerBarProps = PropsRuntime<'conversation.composer.bar'> & PropsRenderSlots<'conversation.input.add' | 'conversation.input.attachments' | 'conversation.input.model'> & InjectFace<ComposerBarInjected> & PropsLocale<'conversation'>;
/**
 ...
 */
export type ConversationSlotProps = PropsRuntime<'conversation'> & PropsRenderSlots<'conversation.session' | 'conversation.session.header' | 'conversation.session.workspace' | 'conversation.session.panes' | 'conversation.composer' | 'conversation.composer.bar' | 'conversation.input.overlay' | 'conversation.input.dock' | 'conversation.composer.dock' | 'conversation.input.left' | 'conversation.input.right' | 'conversation.hero.brand.mark' | 'conversation.hero.workspace' | 'conversation.hero.agentPreset' | 'conversation.hero.actions'> & InjectFace<ConversationInjected> & PropsLocale<'conversation'>;
...
export type ComposerAddProps = PropsRuntime<'conversation.input.add'> & PropsLocale<'conversation'>;
