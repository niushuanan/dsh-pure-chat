...
import type { InputEffect, InputEvent, InputMachineOptions, InputState, PersistedInputDraft } from './contract.ts';
...
export declare const DOCK_REFERENCE_MARKER = "\u2060";
/**
 ...
 */
export declare function referenceDraftText(reference: Pick<ReferenceInsert, 'label' | 'presentation'>): string;
/**
 ...
 */
export declare function projectPersistedDraft(state: Pick<InputState, 'draft' | 'occurrences'>): PersistedInputDraft;
/**
