...
import type { OptimisticUserMessage } from '@deepseek-ai/dsh-client-runtime/client';
...
export declare function extractQuotedSelections(text: string): {
...
export declare function OptimisticUserBubble({ message, renderMessageImages, t }: {
