window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function AgentPresetLabel({ sessionId, useSessions, useAgentPresets, useAgentPresetSwitch, load, switchPreset, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
					...
					onSelect: (id) => {
						setOpen(false);
						switchPreset(sessionId, id);
					},
					align: "end",
					portal: true,
					anchor: (0, react_jsx_runtime.jsxs)("button", {
						type: "button",
						className: AgentPresetLabel_module_css_default.button,
						"aria-haspopup": "menu",
						"aria-expanded": open,
						...
						children: [
							(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconAgentPresetOutline16, {
								size: 14,
								className: AgentPresetLabel_module_css_default.icon
							}),
							(0, react_jsx_runtime.jsx)("span", {
								className: AgentPresetLabel_module_css_default.name,
								children: text?.name ?? preset
							}),
							status === void 0 ? null : (0, react_jsx_runtime.jsx)("span", {
								className: AgentPresetLabel_module_css_default.status,
								children: status
							}),
							(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: open ? AgentPresetLabel_module_css_default.chevronOpen : AgentPresetLabel_module_css_default.chevron })
						]
					})
				}), switchState?.error === null || switchState?.error === void 0 ? null : (0, react_jsx_runtime.jsx)("span", {
					className: AgentPresetLabel_module_css_default.visuallyHidden,
					role: "status",
					children: switchState.error
				})]
			});
		}
		//#endregion
		...
		*/
		...
		const INTERNAL_AGENT_PRESET_IDS = new Set(["chat"]);
		/**
		...
		*/
		function presetOptions(presets) {
			return presets.filter((preset) => preset.broken === void 0 && !INTERNAL_AGENT_PRESET_IDS.has(preset.id)).map((preset) => ({
				id: preset.id,
				trust: preset.trust,
