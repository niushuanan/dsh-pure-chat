window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/MessageItem.module.css.mjs
		const css$15 = ".aEcBrG_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.aEcBrG_userStack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;gap:8px;display:flex}.aEcBrG_bubble{background:var(--dsw-specific-bubble);max-width:100%;font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:22px;padding:10px 16px}.aEcBrG_referenceSummary{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.aEcBrG_contextRow,.aEcBrG_compactionRow{padding:2px 0}.aEcBrG_compactionButton{width:100%;height:calc(24px + var(--dsh-content-font-delta,0px));min-width:0;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.aEcBrG_compactionButton:not(:disabled){cursor:pointer}.aEcBrG_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.aEcBrG_compactionLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.aEcBrG_compactionLeading svg{width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.aEcBrG_compactionContextIcon,.aEcBrG_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.aEcBrG_compactionDisclosureIcon,.aEcBrG_compactionButton:not(:disabled):hover .aEcBrG_compactionContextIcon,.aEcBrG_compactionButton:not(:disabled):focus-visible .aEcBrG_compactionContextIcon{opacity:0}.aEcBrG_compactionButton:not(:disabled):hover .aEcBrG_compactionDisclosureIcon,.aEcBrG_compactionButton:not(:disabled):focus-visible .aEcBrG_compactionDisclosureIcon{opacity:1}.aEcBrG_compactionTitle{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary-dimmed);flex:none}.aEcBrG_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.aEcBrG_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.aEcBrG_compactionBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}.aEcBrG_retryRow{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px))}.aEcBrG_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.aEcBrG_retrySummary::-webkit-details-marker{display:none}.aEcBrG_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.aEcBrG_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.aEcBrG_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.aEcBrG_retryText{color:inherit}.aEcBrG_retryRow[data-active] .aEcBrG_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite aEcBrG_retry-shimmer}.aEcBrG_retryRow[open] .aEcBrG_retrySummary:after{transform:rotate(45deg)}.aEcBrG_retryDetails{overflow-wrap:anywhere;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));gap:2px;margin-top:3px;padding-left:14px;display:grid}.aEcBrG_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.aEcBrG_turnErrorRow{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;display:grid}.aEcBrG_turnErrorDot{margin-top:5px}.aEcBrG_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.aEcBrG_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.aEcBrG_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.aEcBrG_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.aEcBrG_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes aEcBrG_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.aEcBrG_retryRow[data-active] .aEcBrG_retryText{color:inherit;background:0 0;animation:none}}";
		...
		var MessageItem_module_css_default = {
			"bubble": "aEcBrG_bubble",
			"compactionBody": "aEcBrG_compactionBody",
			"compactionButton": "aEcBrG_compactionButton",
			"compactionContextIcon": "aEcBrG_compactionContextIcon",
			"compactionDisclosureIcon": "aEcBrG_compactionDisclosureIcon",
			"compactionLeading": "aEcBrG_compactionLeading",
			"compactionRow": "aEcBrG_compactionRow",
			"compactionSep": "aEcBrG_compactionSep",
			"compactionSummary": "aEcBrG_compactionSummary",
			"compactionTitle": "aEcBrG_compactionTitle",
			"contextRow": "aEcBrG_contextRow",
			"maxTokensTitle": "aEcBrG_maxTokensTitle",
			"referenceSummary": "aEcBrG_referenceSummary",
			"retry-shimmer": "aEcBrG_retry-shimmer",
			"retryDetailLabel": "aEcBrG_retryDetailLabel",
			"retryDetails": "aEcBrG_retryDetails",
			"retryRow": "aEcBrG_retryRow",
			"retrySummary": "aEcBrG_retrySummary",
			"retryText": "aEcBrG_retryText",
			"turnErrorCode": "aEcBrG_turnErrorCode",
			"turnErrorCopy": "aEcBrG_turnErrorCopy",
			"turnErrorDot": "aEcBrG_turnErrorDot",
			"turnErrorMessage": "aEcBrG_turnErrorMessage",
			"turnErrorRow": "aEcBrG_turnErrorRow",
			"turnErrorTitle": "aEcBrG_turnErrorTitle",
			"userRow": "aEcBrG_userRow",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/ContextBody.module.css.mjs
		const css$14 = ".VxPBRW_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.VxPBRW_fields{border-top:1px solid var(--dsw-alias-line-secondary);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}.VxPBRW_field{gap:8px;min-width:0;display:flex}.VxPBRW_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}.VxPBRW_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}.VxPBRW_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}.VxPBRW_file{align-items:baseline;gap:6px;min-width:0;display:flex}.VxPBRW_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.VxPBRW_fileAction{color:var(--dsw-alias-label-caption)}.VxPBRW_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}.VxPBRW_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.VxPBRW_entry{gap:8px;min-width:0;display:flex}.VxPBRW_entryName{color:var(--dsw-alias-label-secondary);flex:none}.VxPBRW_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.VxPBRW_sections{flex-direction:column;gap:8px;margin:0;display:flex}.VxPBRW_section{flex-direction:column;gap:2px;min-width:0;display:flex}.VxPBRW_sectionName{color:var(--dsw-alias-label-caption)}.VxPBRW_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.VxPBRW_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}.VxPBRW_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}.VxPBRW_recall{gap:8px;min-width:0;display:flex}.VxPBRW_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.VxPBRW_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		...
		var ContextBody_module_css_default = {
			"catalogNotice": "VxPBRW_catalogNotice",
			"entries": "VxPBRW_entries",
			"entry": "VxPBRW_entry",
			"entryDescription": "VxPBRW_entryDescription",
			"entryName": "VxPBRW_entryName",
			"field": "VxPBRW_field",
			"fieldKey": "VxPBRW_fieldKey",
			"fieldValue": "VxPBRW_fieldValue",
			"fields": "VxPBRW_fields",
			"file": "VxPBRW_file",
			"fileAction": "VxPBRW_fileAction",
			"filePath": "VxPBRW_filePath",
			"files": "VxPBRW_files",
			"recall": "VxPBRW_recall",
			"recallCounts": "VxPBRW_recallCounts",
			"recallLabel": "VxPBRW_recallLabel",
			"recalls": "VxPBRW_recalls",
			"relaySender": "VxPBRW_relaySender",
			"section": "VxPBRW_section",
			"sectionName": "VxPBRW_sectionName",
			"sectionText": "VxPBRW_sectionText",
			"sections": "VxPBRW_sections",
			"text": "VxPBRW_text"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/ContextInjectionRow.module.css.mjs
		const css$13 = ".laz-Ya_root{min-width:0}.laz-Ya_root[data-open]{padding-bottom:4px}.laz-Ya_chevron{color:var(--dsw-alias-label-secondary)}.laz-Ya_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.laz-Ya_source{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.laz-Ya_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.laz-Ya_body{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));max-height:141px;margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;padding:10px 16px 12px 12px;overflow:auto}";
		...
		var ContextInjectionRow_module_css_default = {
			"body": "laz-Ya_body",
			"chevron": "laz-Ya_chevron",
			"root": "laz-Ya_root",
			"sep": "laz-Ya_sep",
			"source": "laz-Ya_source",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/MessageIconActions.module.css.mjs
		const css$12 = ".awpErG_actions{height:calc(28px + var(--dsh-content-font-delta,0px));align-items:center;gap:10px;display:flex}.awpErG_timeStart{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px}.awpErG_timeEnd{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-left:12px}.awpErG_runTimeDot{margin:0 10px}@media (hover:hover){[data-time-hover-root] :is(.awpErG_timeStart,.awpErG_timeEnd){opacity:0;transition:opacity 80ms}[data-time-hover-root]:hover :is(.awpErG_timeStart,.awpErG_timeEnd),[data-time-hover-root]:focus-within :is(.awpErG_timeStart,.awpErG_timeEnd){opacity:1}}.awpErG_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.awpErG_action svg{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px))}.awpErG_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.awpErG_action[data-unavailable]{cursor:default;opacity:.4}.awpErG_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}.awpErG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var MessageIconActions_module_css_default = {
			"action": "awpErG_action",
			"actions": "awpErG_actions",
			"runTimeDot": "awpErG_runTimeDot",
			"timeEnd": "awpErG_timeEnd",
			"timeStart": "awpErG_timeStart",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/ChatView.module.css.mjs
		const css$11 = ".SyCKCG_root{flex-direction:column;flex:auto;min-height:0;display:flex;position:relative}.SyCKCG_scroll{min-height:0;padding:16px calc(var(--dsh-composer-side-clearance) + 16px);flex:auto;overflow-y:auto;container-type:inline-size}[data-conversation-scroll] .SyCKCG_root{flex:none;height:auto;min-height:auto}[data-conversation-scroll] .SyCKCG_scroll{flex:none;min-height:auto;overflow:visible}.SyCKCG_column{max-width:var(--dsh-chat-content-width);flex-direction:column;width:100%;margin:0 auto;display:flex}.SyCKCG_column>:not([hidden]):not(.SyCKCG_flowItem:empty)~:not([hidden]):not(.SyCKCG_flowItem:empty){margin-top:var(--dsh-chat-flow-gap,16px)}.SyCKCG_flowItem{min-width:0}.SyCKCG_flowItem[data-turn-process-answer]{--dsh-chat-flow-gap:8px}.SyCKCG_flowItem:empty{display:none}.SyCKCG_callRow{border-radius:6px}.SyCKCG_turnStatus{height:calc(26px + var(--dsh-content-font-delta,0px));font:var(--dsw-font-s-strong-14);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:nowrap;background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 0%, var(--dsw-static-deepseek-500) 40%, var(--dsw-static-deepseek-200) 50%, var(--dsw-static-deepseek-500) 60%, var(--dsw-static-deepseek-500) 100%);color:#0000;-webkit-text-fill-color:transparent;background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;flex:none;align-self:flex-start;align-items:center;animation:1.8s linear infinite SyCKCG_dsh-turn-status-shimmer;display:inline-flex}.SyCKCG_turnStatusClock{font:var(--dsw-font-xs-13);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-caption);-webkit-text-fill-color:var(--dsw-alias-label-caption);margin-left:8px;font-weight:400}@keyframes SyCKCG_dsh-turn-status-shimmer{to{background-position:0 0}}@media (prefers-reduced-motion:reduce){.SyCKCG_turnStatus{background-position:0 0;background-size:100% 100%;animation:none}}.SyCKCG_hint{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.SyCKCG_openError{color:var(--dsw-alias-state-error-primary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.SyCKCG_older{justify-content:center;display:flex}.SyCKCG_older button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover-solid);cursor:pointer;border:none;border-radius:14px;padding:4px 12px;font-size:12px}.SyCKCG_older button:disabled{cursor:default;opacity:.6}.SyCKCG_toBottomSlot{z-index:8;height:0;padding-right:max(0px, calc((100% - var(--dsh-chat-content-width)) / 2));pointer-events:none;justify-content:flex-end;display:flex;position:sticky;bottom:16px}[data-conversation-scroll] .SyCKCG_toBottomSlot{bottom:calc(var(--dsh-composer-height,152px) + 16px)}.SyCKCG_toBottom{border:1px solid var(--dsw-alias-border-l2);width:34px;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-floating-fill);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;pointer-events:auto;border-radius:100px;justify-content:center;align-items:center;margin-top:-34px;padding:0;display:flex}.SyCKCG_toBottom:hover{background:var(--dsw-alias-button-floating-hover)}.SyCKCG_modalAction{min-width:72px}";
		...
		var ChatView_module_css_default = {
			"callRow": "SyCKCG_callRow",
			"column": "SyCKCG_column",
			"dsh-turn-status-shimmer": "SyCKCG_dsh-turn-status-shimmer",
			"flowItem": "SyCKCG_flowItem",
			"hint": "SyCKCG_hint",
			"modalAction": "SyCKCG_modalAction",
			"older": "SyCKCG_older",
			"openError": "SyCKCG_openError",
			"root": "SyCKCG_root",
			"scroll": "SyCKCG_scroll",
			"toBottom": "SyCKCG_toBottom",
			"toBottomSlot": "SyCKCG_toBottomSlot",
			"turnStatus": "SyCKCG_turnStatus",
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/TurnNavigator.module.css.mjs
		const css$10 = ".oxfbkG_slot{z-index:6;pointer-events:none;height:0;position:sticky;top:0}.oxfbkG_rail{--turn-rail-band:calc(var(--dsh-conversation-viewport-height,100dvh) - var(--dsh-composer-height,152px));--turn-preview-height:120px;top:calc(var(--turn-rail-band) / 2);left:calc(12px - (var(--dsh-composer-side-clearance) + 16px));width:28px;height:min(var(--turn-natural-height), max(0px, calc(var(--turn-rail-band) - 64px)), 420px);cursor:pointer;pointer-events:auto;transition:height .22s cubic-bezier(.2,.8,.2,1);position:absolute;transform:translateY(-50%)}.oxfbkG_marks{inset:var(--turn-rail-inset) 0;position:absolute}.oxfbkG_markPosition{top:min(var(--turn-natural-position), var(--turn-position));height:10px;transition:top .22s cubic-bezier(.2,.8,.2,1);animation:.15s ease-out oxfbkG_dsh-turn-mark-enter;position:absolute;left:0;right:0;transform:translateY(-50%)}.oxfbkG_mark{cursor:pointer;pointer-events:none;background:0 0;border:0;border-radius:8px;width:20px;padding:0;position:absolute;inset:0 auto 0 0}.oxfbkG_mark:before{background:var(--dsw-alias-border-l4);content:\"\";border-radius:2px;width:12px;height:2px;transition:width .14s,background-color .14s;position:absolute;top:50%;left:0;transform:translateY(-50%)}.oxfbkG_markPreview:before{background:var(--dsw-alias-label-tertiary);width:18px}.oxfbkG_markActive:before{background:var(--dsw-alias-label-primary);width:20px}.oxfbkG_mark:focus-visible:before{background:var(--dsw-alias-state-business-primary);width:20px}.oxfbkG_mark:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.oxfbkG_preview{top:clamp(0px, calc(min(var(--turn-natural-position), var(--turn-position)) + var(--turn-rail-inset) - var(--turn-preview-height) / 2), calc(100% - var(--turn-preview-height)));box-sizing:border-box;width:min(300px,100cqw - 120px);max-height:var(--turn-preview-height);border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-shadow-lv2);pointer-events:none;border-radius:10px;padding:10px 12px;transition:top .14s cubic-bezier(.2,.8,.2,1);animation:.12s ease-out oxfbkG_dsh-turn-preview-enter;position:absolute;left:calc(100% + 10px);overflow:hidden}.oxfbkG_previewTurn,.oxfbkG_previewPrompt,.oxfbkG_previewResponse{-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.oxfbkG_previewTurn{font:var(--dsw-font-xs-strong-13);-webkit-line-clamp:1}.oxfbkG_previewPrompt{font:var(--dsw-font-xs-13);-webkit-line-clamp:2;margin-top:4px}.oxfbkG_previewResponse{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xxs-12);-webkit-line-clamp:2;margin-top:4px}@keyframes oxfbkG_dsh-turn-mark-enter{0%{opacity:0}to{opacity:1}}@keyframes oxfbkG_dsh-turn-preview-enter{0%{opacity:0;transform:translate(-4px)}to{opacity:1;transform:translate(0)}}@container (width<=480px){.oxfbkG_slot{display:none}}@media (prefers-reduced-motion:reduce){.oxfbkG_rail,.oxfbkG_markPosition,.oxfbkG_mark:before,.oxfbkG_preview{transition:none;animation:none}}";
		...
		var TurnNavigator_module_css_default = {
			"dsh-turn-mark-enter": "oxfbkG_dsh-turn-mark-enter",
			"dsh-turn-preview-enter": "oxfbkG_dsh-turn-preview-enter",
			"mark": "oxfbkG_mark",
			"markActive": "oxfbkG_markActive",
			"markPosition": "oxfbkG_markPosition",
			"markPreview": "oxfbkG_markPreview",
			"marks": "oxfbkG_marks",
			"preview": "oxfbkG_preview",
			"previewPrompt": "oxfbkG_previewPrompt",
			"previewResponse": "oxfbkG_previewResponse",
			"previewTurn": "oxfbkG_previewTurn",
			"rail": "oxfbkG_rail",
			"slot": "oxfbkG_slot"
		};
		//#endregion
		...
		*/
		function ChatView({ useSession, useChat, useSessions, useStore, actions, renderSlot, sessionId, openFile, loadOlder, loadImage, openView, chatScroll, forkAt, fileMentions, useTranscriptView, t }) {
			...
			*  scrolls the rest of the way to the floor). */
			...
			const requestedHistoryHead = (0, react.useRef)(null);
			(0, react.useEffect)(() => {
				if (openState !== "open") {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/accessibility.module.css.mjs
		const css$9 = "._9xpOvG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var accessibility_module_css_default = { "visuallyHidden": "_9xpOvG_visuallyHidden" };
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/ReasoningRow.module.css.mjs
		const css$8 = "._4G665G_root{flex-direction:column;display:flex}._4G665G_row{position:relative;overflow:hidden}._4G665G_root[data-state=running] ._4G665G_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _4G665G_dsh-reasoning-row-sweep;position:absolute;left:0}@keyframes _4G665G_dsh-reasoning-row-sweep{0%{left:-300px}90%,to{left:100%}}._4G665G_leading{flex-shrink:0}._4G665G_chevron{color:var(--dsw-alias-label-secondary)}._4G665G_title{font-weight:400}._4G665G_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._4G665G_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}._4G665G_summary[data-follow-end]{text-overflow:clip}._4G665G_thinkBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:pre-wrap;word-break:break-word}@media (prefers-reduced-motion:reduce){._4G665G_root[data-state=running] ._4G665G_row:after{animation:none}}";
		...
		var ReasoningRow_module_css_default = {
			"chevron": "_4G665G_chevron",
			"dsh-reasoning-row-sweep": "_4G665G_dsh-reasoning-row-sweep",
			"leading": "_4G665G_leading",
			"root": "_4G665G_root",
			"row": "_4G665G_row",
			"separator": "_4G665G_separator",
			"summary": "_4G665G_summary",
			"thinkBody": "_4G665G_thinkBody",
			"title": "_4G665G_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/AssistantMarkdown.module.css.mjs
		const css$7 = ".j1dK7a_root{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.j1dK7a_body{flex-direction:column;gap:16px;display:flex}.j1dK7a_body .md-table-wide{--dsh-table-spare:max(0px, calc((100cqw - var(--dsh-chat-content-width)) / 2));--dsh-table-lead:calc(var(--dsh-table-spare) + min(var(--dsh-chat-content-width), 100cqw) - 100%);box-sizing:border-box;width:calc(100% + var(--dsh-table-lead) + var(--dsh-table-spare));max-width:none;margin-left:calc(-1 * var(--dsh-table-lead));padding-left:var(--dsh-table-lead)}.j1dK7a_body>[data-turn-process-inline][hidden]{margin-bottom:-16px}.j1dK7a_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.j1dK7a_actions{margin-top:16px;margin-left:-6px}";
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/GenericCommandCard.module.css.mjs
		const css$6 = ".QroMFa_root{flex-direction:column;display:flex}.QroMFa_row{position:relative;overflow:hidden}.QroMFa_root[data-state=running] .QroMFa_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite QroMFa_dsh-command-row-sweep;position:absolute;left:0}@keyframes QroMFa_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}.QroMFa_leading{flex-shrink:0}.QroMFa_chevron{color:var(--dsw-alias-label-secondary)}.QroMFa_title{font-weight:400}.QroMFa_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.QroMFa_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.QroMFa_summary[data-error],.QroMFa_body[data-error]{color:var(--dsw-alias-state-error-primary)}.QroMFa_body{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){.QroMFa_root[data-state=running] .QroMFa_row:after{animation:none}}";
		...
		var GenericCommandCard_module_css_default = {
			"body": "QroMFa_body",
			"chevron": "QroMFa_chevron",
			"dsh-command-row-sweep": "QroMFa_dsh-command-row-sweep",
			"leading": "QroMFa_leading",
			"root": "QroMFa_root",
			"row": "QroMFa_row",
			"separator": "QroMFa_separator",
			"summary": "QroMFa_summary",
			"title": "QroMFa_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/TurnProcessNodeView.module.css.mjs
		const css$5 = ".zen7dW_root{box-sizing:border-box;border:none;border-bottom:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:33px;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;align-items:center;padding:0 0 8px;display:flex}.zen7dW_root:not([data-open]){margin-bottom:8px}.zen7dW_chevron{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:6px;transition:transform .1s;transform:rotate(-90deg)}.zen7dW_root[data-open] .zen7dW_chevron{transform:rotate(0)}.zen7dW_label{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:24px;overflow:hidden}@media (prefers-reduced-motion:reduce){.zen7dW_chevron{transition:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/TurnUsageDisclosure.module.css.mjs
		const css$4 = "._6i5AEG_root{min-width:0}._6i5AEG_root[data-open]{padding-bottom:4px}._6i5AEG_root [data-disclosure-row]:focus-visible{outline:2px solid var(--dsw-alias-label-tertiary);outline-offset:-2px;border-radius:6px}._6i5AEG_chevron{color:var(--dsw-alias-label-secondary)}._6i5AEG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._6i5AEG_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);font-variant-numeric:tabular-nums;line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._6i5AEG_details{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);border-radius:8px;grid-template-columns:minmax(76px,auto) minmax(0,1fr);gap:6px 16px;padding:10px 16px 12px 12px;font-size:12px;line-height:18px;display:grid}._6i5AEG_details dt,._6i5AEG_details dd{min-width:0;margin:0}._6i5AEG_details dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right}._6i5AEG_details ._6i5AEG_route{overflow-wrap:anywhere}._6i5AEG_reasoning{color:var(--dsw-alias-label-tertiary);white-space:nowrap}._6i5AEG_totalLabel,._6i5AEG_details ._6i5AEG_totalValue{border-top:1px solid var(--dsw-alias-separator-primary);color:var(--dsw-alias-label-primary);padding-top:6px}@media (width<=480px){._6i5AEG_details{gap-inline:10px;grid-template-columns:minmax(72px,auto) minmax(0,1fr)}}";
		...
		var TurnUsageDisclosure_module_css_default = {
			"chevron": "_6i5AEG_chevron",
			"details": "_6i5AEG_details",
			"reasoning": "_6i5AEG_reasoning",
			"root": "_6i5AEG_root",
			"route": "_6i5AEG_route",
			"separator": "_6i5AEG_separator",
			"summary": "_6i5AEG_summary",
			"totalLabel": "_6i5AEG_totalLabel",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/TurnTailNodeView.module.css.mjs
		const css$3 = ".WtpkEq_root{flex-direction:column;gap:16px;display:flex}.WtpkEq_footer{flex-direction:column;gap:4px;min-width:0;display:flex}.WtpkEq_actions{margin-left:-6px}";
		...
		var TurnTailNodeView_module_css_default = {
			"actions": "WtpkEq_actions",
			"footer": "WtpkEq_footer",
			"root": "WtpkEq_root"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/chat/StatsLine.module.css.mjs
		const css$2 = ".srIWLG_root{text-align:center;max-width:var(--dsh-chat-content-width);box-sizing:border-box;width:100%;padding:4px calc(var(--dsh-composer-side-clearance) + 16px) 0px;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;margin:0 auto;display:block;overflow:hidden}.srIWLG_sep{color:var(--dsw-alias-separator-primary);margin:0 10px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/details/DetailsPanel.module.css.mjs
		const css$1 = ".rFJJpq_root{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex-direction:column;min-width:0;height:100%;display:flex}.rFJJpq_header{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:8px;padding:14px 12px 12px;display:flex}.rFJJpq_title{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.rFJJpq_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;place-items:center;display:grid}.rFJJpq_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.rFJJpq_body{flex:1;min-height:0;padding:12px 16px;overflow-y:auto}.rFJJpq_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}.rFJJpq_section{margin-bottom:16px}.rFJJpq_sectionLabel{color:var(--dsw-alias-label-secondary);margin-bottom:6px;font-size:12px;font-weight:500;line-height:18px}.rFJJpq_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.rFJJpq_code[data-error]{color:var(--dsw-alias-state-error-primary)}";
		...
		var DetailsPanel_module_css_default = {
			...
			"code": "rFJJpq_code",
			"empty": "rFJJpq_empty",
			"header": "rFJJpq_header",
			"root": "rFJJpq_root",
			"section": "rFJJpq_section",
			"sectionLabel": "rFJJpq_sectionLabel",
			"title": "rFJJpq_title"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/Users/zhuanghongkai/Desktop/迭代DSH/xiaozhuang-dsh/packages/client/ui-chat/src/client/settings/TranscriptViewRow.module.css.mjs
		const css = ".vYWcpG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.vYWcpG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.vYWcpG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.vYWcpG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.vYWcpG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.vYWcpG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.vYWcpG_chevron{flex:none}";
		...
		var TranscriptViewRow_module_css_default = {
			"chevron": "vYWcpG_chevron",
			"desc": "vYWcpG_desc",
			"row": "vYWcpG_row",
			"rowText": "vYWcpG_rowText",
			"selector": "vYWcpG_selector",
			"title": "vYWcpG_title"
		};
		//#endregion
